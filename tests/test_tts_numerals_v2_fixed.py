"""
Phase 6 -- Re-test of Phase 5.2's numeral test cases using the improved
Telugu number formatter (natural hundreds/thousands phrasing + stripped
trailing whitespace), replacing the original Phase 5.2 num2words-only
normalization.
"""
...
OUTPUT_DIR = "tests/audio/numeral_review_v2_fixed"
...
def main():
    ...
    for name, raw_text in TEST_CASES.items():
